export default function Loading() {
  return (
    <div className="min-h-screen w-full bg-rpb-primary pb-24 md:pb-28">
      ...
      <div className="pointer-events-none fixed top-[72px] right-0 left-0 z-[55] md:top-[82px]">
        <div className="h-5 rounded-t-[28px] bg-white md:h-6 md:rounded-t-[34px]" />
      </div>
      <main className="min-h-screen pt-[92px] md:pt-[106px]">
        <div className="rpb-shell min-h-[calc(100vh-92px)] bg-white md:min-h-[calc(100vh-106px)]">
